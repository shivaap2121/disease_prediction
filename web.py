...
st.set_page_config(page_title='Prediction of Disease Outbreaks',
                   layout='wide',
                   page_icon="🧑‍⚕️")
diabetes_model = pickle.load(open("training_model/diabetes_model.sav", "rb"))
heart_disease_model = pickle.load(open("training_model/heart_disease_model.sav", "rb"))
parkinsons_model = pickle.load(open("training_model/parkinsons_model.sav", "rb"))
